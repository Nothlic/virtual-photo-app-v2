      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          for (i = 0; i < data.length; i++) {
            ...
            html += "<div class='inlineContainer'><img class='inlineIcon' src=''><div class='otherBubble other' style='word-wrap: break-word;'>" + "<h4 style='color:white'><b>" + data[i].nama + "</b></h4><h5 style='color:white'>" + data[i].isi + "</h5></div></div><span class='other'></span>";
