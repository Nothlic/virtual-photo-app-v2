<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg">
          ...
          <img src="<?php echo base_url() ?>assets/assetsfront2/images/footerhd.png" style="transform:scale(1.2);margin-top:50px"class="img-fluid" alt="Responsive image">
...
<script>
        var registration = "<?php echo $registration; ?>";
        if(registration == "OK"){
           swal({
